...
TOPIC_KEYWORDS = {
    "python": [
        ...
        "decorator", "generator", "pip", "virtualenv", "pytest", "anaconda"
    ],
    "java": [
        "java", "spring", "maven", "gradle", "jvm", "inheritance",
        "polymorphism", "interface", "abstract", "ocp", "jdk", "servlet"
    ],
    "javascript": [
        "javascript", "js", "node", "react", "vue", "angular", "express",
        "typescript", "npm", "webpack", "babel", "async", "promise", "closure"
    ],
    "typescript": [
        "typescript", "ts", "interface", "generic", "type", "enum", "decorator"
    ],
    "cpp": [
        "c++", "cpp", "pointer", "template", "stl", "namespace",
        "virtual", "destructor", "constructor", "vector", "iterator"
    ],
    "csharp": [
        "c#", "csharp", ".net", "dotnet", "linq", "entity framework",
        "asp.net", "xamarin", "blazor"
    ],
    "go": [
        "golang", "go", "goroutine", "channel", "defer", "interface",
        "package", "module"
    ],
    "rust": [
    ...
    "php": [
        "php", "laravel", "symfony", "composer", "namespace", "trait"
    ],
    "ruby": [
        "ruby", "rails", "gem", "bundler", "rake", "rspec"
    ],
    "swift": [
        "swift", "ios", "xcode", "swiftui", "optional", "protocol"
    ],
    "kotlin": [
        "kotlin", "android", "coroutine", "data class", "sealed class"
    ],
    "web": [
        "html", "css", "sass", "scss", "bootstrap", "tailwind",
        "responsive", "dom", "browser", "frontend"
    ],
    "data-science": [
        "data science", "pandas", "numpy", "matplotlib", "jupyter",
        "scikit-learn", "statistics", "analysis", "visualization"
    ],
    "machine-learning": [
        "machine learning", "ml", "deep learning", "neural network",
        "tensorflow", "pytorch", "model", "training", "ai"
    ],
    "sql": [
        "sql", "database", "query", "select", "join", "index",
        "postgres", "mysql", "mongodb", "nosql"
    ],
    "algorithms": [
        "algorithm", "sorting", "searching", "graph", "tree",
        "dynamic programming", "recursion", "complexity", "big o"
    ],
    "system-design": [
        "system design", "architecture", "scalability", "microservices",
        "load balancing", "caching", "database design", "distributed"
    ]
}
...
PROGRAMMING_KEYWORDS = [
    # General programming
    "code", "coding", "program", "programming", "software", "develop",
    "function", "method", "class", "object", "variable", "array",
    "loop", "condition", "algorithm", "debug", "error", "exception",
    
    # Concepts
    "api", "rest", "http", "json", "xml", "database", "cache",
    "testing", "deployment", "version control", "git",
    
    # Common terms
    "syntax", "compile", "runtime", "memory", "thread", "process",
...
class RAGService:
    ...
    def is_programming_question(self, query: str) -> bool:
        ...
        logger.info(f"ℹ️  Not detected as programming question")
        return False
    ...
    def detect_topic(self, query: str) -> Optional[str]:
        ...
        if not topic_matches:
            logger.info(f"ℹ️  No specific topic detected, will search all documents")
            return None
    ...
    def get_context(
        ...
        try:
            ...
            if not self.is_programming_question(query):
                logger.info(f"⏭️  Skipping RAG (not programming-related)")
                return None
            ...
            if not results:
                logger.info(f"ℹ️  No relevant context found")
                return None
            
            # 4. Format context for LLM
            context_text = self._format_context(results)
            
            logger.info(f"✅ Retrieved {len(results)} chunks from {len(set(r['document_id'] for r in results))} documents")
...
Please answer using the information from these materials when relevant."""
        ...
        logger.info(f"✅ Enhanced prompt with {rag_result['chunks_count']} chunks from {len(rag_result['sources'])} documents")
